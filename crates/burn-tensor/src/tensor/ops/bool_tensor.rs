...
pub trait BoolTensorOps<B: Backend> {
    ...
    fn bool_into_data(tensor: BoolTensor<B>) -> impl Future<Output = TensorData>;
    ...
    fn bool_argwhere(tensor: BoolTensor<B>) -> impl Future<Output = IntTensor<B>> {
        async {
    ...
    fn bool_nonzero(tensor: BoolTensor<B>) -> impl Future<Output = Vec<IntTensor<B>>> {
        async {
